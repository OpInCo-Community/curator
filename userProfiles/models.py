...
class CustomUser(AbstractUser):
    ...
    profile_pic = models.ImageField(upload_to="profile_pic/",default="/static/images/default_profile.jpg", null=True, blank=True)
    ...
    def get_profile_pic(self):
        ...
        return self.profile_pic if self.profile_pic else "/static/images/default_profile.jpg" 
